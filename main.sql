...
INSERT INTO Item (ItemName, ItemType, ItemColour) VALUES
  ('Boots-snakeproof','C','Green'),('Camel Saddle','R','Brown'), ('Compass','N',' '),('Elephant polo stick','R','Bamboo'),('Exploring in 10 Easy Lessons','B',' '),('Geo positioning system',	'N',' '),('Hammock', 'F','Khaki'),('Hat-Polar Explorer',	'C', 'White'), ('How to Win Foreign Friends',	'B',	' '),('Map case',	'E',	'Brown'),('Map measure',	'N',	' '),('Pith Helmet',	'C','Khaki'),('Pocket knife-Avon',	'E',	'Brown'),('Pocket knife-Nile',	'E',	'Brown'),('Safari chair',	'F',	'Khaki'),('Safari cooking kit',	'F',	' '), ('Sextant',	'N',' '),('Stetson',	'C',	'Black'),('Tent - 2 person',	'F',	'Khaki'),('Tent - 8 person',	'F',	'Khaki');

INSERT INTO Employee(EmployeeNumber,EmployeeName,EmployeeSalary,DepartmentName,BossNumber) VALUES
  (1,'Alice',75000,	'Management',	NULL),(2,'Ned',	45000,	'Marketing',	1), (3,'Andrew',25000,	'Marketing',	2),(4,'Clare',	22000,'Marketing',	2),(5,'Todd',	38000,	'Accounting',	1),(6,'Nancy',	22000,	'Accounting',	5),(7,'Brier',	43000,	'Purchasing',	1),(8,'Sarah',	56000,	'Purchasing',	7),(9,'Sophie',	35000,	'Personnel',	1),(10,'Sanjay',	15000,	'Navigation',	3),(11,'Rita',	15000,	'Books',	4),(12,'Gigi',	16000,	'Clothes',	4),(13,'Maggie',	16000,	'Clothes',	4),(14,'Paul',	11000,	'Equipment',	3),(15,'James',	15000,	'Equipment',	3),(16,'Pat',	15000,	'Furniture',	3),(17,'Mark',	15000,	'Recreation',	3);

INSERT INTO Department(DepartmentName, DepartmentFloor,DepartmentPhone,EmployeeNumber)VALUES
  ('Management',	5,	34,	1),('Books',	1,	81,	4),('Clothes',	2,	24,	4),('Equipment',	3,	57,	3),('Furniture',	4,	14,	3),('Navigation',	1,	41,	3),('Recreation',	2,	29,	4),('Accounting',	5,	35,	5),('Purchasing',	5,	36,	7),('Personnel',	5,	37,	9),('Marketing',	5,	38,	2);

INSERT INTO Sale(SaleNumber,SaleQuantity,ItemName,DepartmentName) VALUES
  (1001,	2,	'Boots-snakeproof',	'Clothes'),(1002,	1,	'Pith Helmet',	'Clothes'),(1003,	1,	'Sextant',	'Navigation'),(1004,	3,	'Hat-Polar Explorer',	'Clothes'),(1005,	5,	'Pith Helmet',	'Equipment'),(1006,	1,	'Pocket knife-Nile',	'Clothes'),(1007,	1,	'Pocket knife-Nile',	'Recreation'),(1008,	1,	'Compass',	'Navigation'),(1009,	1,	'Geo positioning system',	'Navigation'),(1010,	5,	'Map measure',	'Navigation'),(1011,	1,	'Geo positioning system',	'Books'),(1012,	1,	'Sextant',	'Books'),(1013,	3,	'Pocket knife-Nile',	'Books'),(1014,	1,	'Pocket knife-Nile',	'Navigation'),(1015,	1,	'Pocket knife-Nile',	'Equipment'),(1016,	1,	'Sextant',	'Clothes'),(1017,	1,	'Sextant',	'Equipment'),(1018,	1,	'Sextant',	'Recreation'),(1019,	1,	'Sextant',	'Furniture'),(1020,	1,	'Pocket knife-Nile',	'Furniture'),(1021,	1,	'Exploring in 10 Easy Lessons',	'Books'),(1022,	1,	'How to Win Foreign Friends',	'Books'),(1023,	1,	'Compass',	'Books'),(1024,	1,	'Pith Helmet',	'Books'),(1025,	1,	'Elephant polo stick',	'Recreation'),(1026,	1,	'Camel Saddle',	'Recreation');

INSERT INTO Supplier(SupplierNumber,SupplierName) VALUES
  (101,	'Global Maps and Books'),(102,	'Nepalese Corp.'),(103,	'All Sports Manufacturing'),(104,	'Sweatshops Unlimited'),(105,	'All Points inc.'),(106,	'Sao Paulo Manufacturing');
...
SELECT ItemName 
FROM (Item NATURAL JOIN SALE) 
WHERE DepartmentName = 'Recreation' AND ItemColour = 'Brown';

SELECT DISTINCT SupplierName FROM (Supplier NATURAL JOIN Delivery) WHERE ItemName = "Compass";
...
WHERE Worker.BossNumber = Boss.EmployeeNumber AND Worker.EmployeeSalary > Boss.EmployeeSalary;

SELECT Worker.EmployeeName, Worker.DepartmentName, Boss.EmployeeName
FROM Employee AS Worker, Employee as Boss
WHERE Worker.BossNumber = Boss.EmployeeNumber AND Worker.DepartmentName=Boss.DepartmentName;
...
SELECT Worker.EmployeeName, Worker.EmployeeSalary, Boss.EmployeeName
FROM Employee AS Worker, Employee AS Boss
WHERE Worker.BossNumber = Boss.EmployeeNumber AND Worker.DepartmentName = "Marketing" AND Worker.EmployeeSalary > 25000;

SELECT ItemName, ItemType, DepartmentName, DepartmentFloor
...
HAVING (SUM(Delivery.DeliveryQuantity))>100 AND (Item.ItemType = 'C' OR Item.ItemType = 'N');
